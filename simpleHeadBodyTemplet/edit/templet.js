        ...
        createTemplet: function (params) {
            ...
            let viewModel = {
                ...
                body: {
                    ...
                    bodyModel: {
                        type: "table",
                        key: "bodyTable",				// KEY 作为ref对象引用 (自定义)
            ...
            params.viewModel.body.bodyModel = params.viewModel.body.bodyModel || {};
            ...
            if (params.viewModel.body.bodyModel.items && params.viewModel.body.bodyModel.items.length) {
                params.viewModel.body.bodyModel.items.forEach(function (item, index, array) {
                    item.size = isNotNull(item.size) ? item.size : viewModel.body.size;
                    viewModel.body.bodyModel.items.push(methodModel.createItemModel(item, Pos.body));
                });
            }
